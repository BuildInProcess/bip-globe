...
const BUILDER_DATA = [
  { id: '1', username: 'kislay', name: 'Kislay', avatar: 'https:forgforg.to/@kislay' },
  { id: '2', username: 'riteshsinha4146', name: 'Ritesh Sinha', avatar: 'https:forgforg.to/@riteshsinha4146' },
  { id: '3', username: 'henry', name: 'Henry', avatar: 'https:forgforg.to/@henry' },
  { id: '4', username: 'aditi_rajj23', name: 'Aditi Raj', avatar: 'https:forgforg.to/@aditi_rajj23' },
  { id: '5', username: 'pirolla40', name: 'Paul Irolla', avatar: 'https:forgforg.to/@pirolla40' },
  { id: '6', username: 'duongphudong', name: 'Dong Phu Duong', avatar: '', location: 'Ho Chi Minh City, Vietnam', lat: 10.8231, lng: 106.6297, tagline: 'Building SaaS tools for SE Asia.', productsCount: 1, profileUrl: 'https://forg.to/@duongphudong' },
  { id: '7', username: 'mostypc7', name: 'Juraj Kollar', avatar: '', location: 'Bratislava, Slovakia', lat: 48.1486, lng: 17.1077, tagline: 'PC builder and dev.', productsCount: 2, profileUrl: 'https://forg.to/@mostypc7' },
  { id: '8', username: 'calchiwo', name: 'Caleb Wodi', avatar: '', location: 'Lagos, Nigeria', lat: 6.5244, lng: 3.3792, tagline: 'Bootstrapped. Building African fintech tools.', productsCount: 1, profileUrl: 'https://forg.to/@calchiwo' },
  { id: '9', username: 'abdulroqeeboladipo', name: 'Oladipo Abdulroqib', avatar: '', location: 'Abuja, Nigeria', lat: 9.0579, lng: 7.4951, tagline: 'Full-stack dev. Shipping one thing at a time.', productsCount: 1, profileUrl: 'https://forg.to/@abdulroqeeboladipo' },
  { id: '10', username: 'lincolnlesola567', name: 'Lincoln Lesola', avatar: '', location: 'Cape Town, South Africa', lat: -33.9249, lng: 18.4241, tagline: 'Building dev tools for African startups.', productsCount: 1, profileUrl: 'https://forg.to/@lincolnlesola567' },
  { id: '11', username: 'maxim.bort.devel', name: 'Maxim Bortnikov', avatar: '', location: 'Berlin, Germany', lat: 52.52, lng: 13.405, tagline: 'Open source contributor.', productsCount: 3, profileUrl: 'https://forg.to/@maxim.bort.devel' },
  { id: '12', username: 'thesukhjitbajwa', name: 'Sukhjit Bajwa', avatar: '', location: 'Toronto, Canada', lat: 43.6532, lng: -79.3832, tagline: 'Canadian indie hacker. SaaS + no-code.', productsCount: 2, profileUrl: 'https://forg.to/@thesukhjitbajwa' },
  { id: '13', username: 'pradeepyad089', name: 'Pradeep Yadav', avatar: '', location: 'Pune, India', lat: 18.5204, lng: 73.8567, tagline: 'Backend engineer shipping side projects.', productsCount: 1, profileUrl: 'https://forg.to/@pradeepyad089' },
  { id: '14', username: 'pastable', name: 'Kit Pastable', avatar: '', location: 'San Francisco, USA', lat: 37.7749, lng: -122.4194, tagline: 'Building Pastable.', productsCount: 1, profileUrl: 'https://forg.to/@pastable' },
  { id: '15', username: 'suresh', name: 'Suresh', avatar: '', location: 'Chennai, India', lat: 13.0827, lng: 80.2707, tagline: 'AI SEO tools.', productsCount: 2, profileUrl: 'https://forg.to/@suresh' },
]
